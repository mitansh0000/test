...
# Bot information
API_ID = environ.get('API_ID', '15503725')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'd11e4a03659488e40429f3c39431b6db') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6008979863:AAEBlLrBrbV4J9C-r0_dtm4DHsTvaTKiHLk') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001500590584').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001500590584') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001816890116') #support group id ex:  -1002936246860
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001500590584") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://auto-filter-bot-lrpg.onrender.com") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
